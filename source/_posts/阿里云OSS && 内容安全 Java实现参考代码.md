...
public class AliAutoRoute {
    ...
    private static final String AccessKeyId = "LTAI5tM72ks5rAhK65eby5go";  //审核通过
    private static final String AccessKeySecret = "nbHAq1DbaCysOQeAO3c24KXkuTIni0";  //审核通过
...
```java
    ...
    public void testOSS() throws IOException {
        AliOssUtil aliOssUtil = AliOssUtil.builder()
                .accessKeyId("LTAI5tM72ks5rAhK65eby5go")
                .accessKeySecret("nbHAq1DbaCysOQeAO3c24KXkuTIni0")
